        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row gap-8">
            ...
            <div className="w-full md:w-1/2 bg-blue-900 text-white rounded-lg p-8 shadow-xl">
              ...
              <p className="mb-8 text-gray-200">{t("contact.description")}</p>
            ...
            <div className="w-full md:w-1/2 h-96 md:h-auto rounded-lg overflow-hidden shadow-xl">
              <iframe
                ...
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3178.8845827076902!2d28.370171175663618!3d37.17921377214145!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14bf732687fd3eb1%3A0x2815d6eefcce8910!2sMu%C4%9Fla%20Teknopark!5e0!3m2!1str!2str!4v1749892933436!5m2!1str!2str"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen=""
