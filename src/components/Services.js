    ...
    <div id="services" className="bg-gray-100 py-12">
      ...
      <section>
        <div className="m-auto max-w-6xl p-2 md:p-12 h-5/6">
          <div
            className="flex flex-col-reverse lg:flex-row py-8 justify-between lg:text-left gap-16 lg:gap-32"
            data-aos="zoom-out">
            <div className="lg:w-1/2 flex flex-col lg:mx-4 justify-center">
              ...
              <h3 className="text-3xl text-blue-900 font-bold">
                <span className="font-black">{t('services.vision.title')}</span>
              </h3>
              <div>
            ...
            <div className="lg:w-1/2 flex flex-col lg:mx-4 justify-center">
              ...
              <h3 className="text-3xl text-blue-900 font-bold">
                <span className="font-black">{t('services.mission.title')}</span>
              </h3>
              <div>
                <div className="mt-4 text-lg text-gray-600 font-semibold flex flex-col space-y-2">
                  {t('services.mission.items', { returnObjects: true }).map((item, index) => (
                    <p key={index}>
